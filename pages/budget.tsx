                ...
                <div className="card">
                  <div className="card-body">
                    <div className="d-flex flex-wrap justify-content-between">
                      <h4 className="card-title mb-3">Impressions / Budget</h4>
                    </div>
                    <div className="row">
                      <div className="col-lg-9">
                        <div className="d-sm-flex justify-content-between">
                          ...
                          <div>
                            <button type="button" className="btn btn-sm btn-light mr-2">All</button>
                            <button type="button" className="btn btn-sm btn-primary mr-2">Sanlam Sky</button>
                            <button type="button" className="btn btn-sm btn-light mr-2">Sanlam Sanport</button>
                            <button type="button" className="btn btn-sm btn-light mr-2">Sanlam Glacier</button>
                            <button type="button" className="btn btn-sm btn-light">SHA</button>
                          </div>
                          <div>
                      ...
                      <div className="col-lg-3">
                        ...
                        <div className="mt-4">
                          ...
                          <div className="d-flex justify-content-between mb-3">
                            ...
                            <div className="text-muted">~8,120 ZAR</div>
                          </div>
                          <div className="d-flex justify-content-between">
                            <div className="font-weight-medium">This month(est.)</div>
                            <div className="text-muted">~36,080 ZAR</div>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div className="row">
                      ...
                      <div className="col-12">
                        <div className="row">
                          <div className="col-12">
                            <div className="d-md-flex ">
                              ...
                              <div className="mr-md-5">
                                ...
                                <p className="mb-1">Alert will be sent when budget reaches 75%</p>
                              </div>
                          ...
                          <div className="d-md-flex">
                            ...
                            <div className="mr-md-5">
                              <h5 className="mb-1 text-warning">   <i style={{fontSize:"2em"}} className="typcn typcn-volume-up"></i> Sanlam Sky</h5>
                              <p className="mb-1">Alert will be sent when overrun reaches  +10%</p>
                            </div>
                          ...
                          <div className="d-md-flex">
                            ...
                            <div className="mr-md-5">
                              ...
                              <p className="mb-1">Alert will be sent when budget reaches 70%</p>
                            </div>
                          ...
                          <div className="d-md-flex">
                            ...
                            <div className="mr-md-5">
                              <h5 className="mb-1 text-warning">   <i style={{fontSize:"2em"}} className="typcn typcn-volume-up"></i> SHA</h5>
                              <p className="mb-1">Alert will be sent when budget reaches 75%</p>
                            </div>
              ...
              <div className="col-lg-8 d-flex grid-margin stretch-card">
                <div className="card">
                  <div className="card-body">
                    <div className="d-flex flex-wrap justify-content-between">
                      <h4 className="card-title mb-3">Campaign budgets</h4>
                    </div>
                      ...
                      <table className="table">
                        <tbody>
                          <tr>
                            ...
                            <td>
                              Running total
                              <div className="font-weight-bold  mt-1">31,982 ZAR </div>
                            </td>
                            <td>
                              Month total
                              <div className="font-weight-bold  mt-1">16,654 ZAR </div>
                            </td>
                            <td>
                              Overrun
                              <div className="font-weight-bold text-success  mt-1">-8% </div>
                            </td>
                            <td>
                              Timeline
                            ...
                            <td>
                              <i className="typcn typcn-eye-outline mr-1"></i>
                            </td>
                          </tr>
                          <tr>
                            <td>
                            ...
                            <td>
                              Running total
                              <div className="font-weight-bold  mt-1">28,090 ZAR </div>
                            </td>
                            <td>
                              Month total
                              <div className="font-weight-bold  mt-1">15,722 ZAR </div>
                            </td>
                            <td>
                              Overrun
                              <div className="font-weight-bold text-success  mt-1">-2% </div>
                            </td>
                            <td>
                            Timeline
                          ...
                          <tr>
                            ...
                            <td>
                              Running total
                              <div className="font-weight-bold  mt-1">34,686 ZAR </div>
                            </td>
                            <td>
                              Month total
                              <div className="font-weight-bold  mt-1">17,560 ZAR </div>
                            </td>
                            <td>
                              Overrun
                              <div className="font-weight-bold text-success  mt-1">-5% </div>
                            </td>
                            <td>
                            Timeline
                          ...
                          <tr>
                            ...
                            <td>
                              Running total
                              <div className="font-weight-bold  mt-1">24,555 ZAR </div>
                            </td>
                            <td>
                              Month total
                              <div className="font-weight-bold  mt-1">7,887 ZAR </div>
                            </td>
                            <td>
                              Overrun
                              <div className="font-weight-bold text-warning  mt-1">+1% </div>
                            </td>
                            <td>
                            Timeline
