                    ...
                    <div class="row">
                      <div class="col-lg-9">
                        <div class="d-sm-flex justify-content-between">
                          ...
                          <div>
                            <button type="button" class="btn btn-sm btn-primary mr-2">All</button>
                            <button type="button" class="btn btn-sm btn-light mr-2">Sanlam Sky</button>
                            <button type="button" class="btn btn-sm btn-light mr-2">Sanlam Sanport</button>
                            <button type="button" class="btn btn-sm btn-light mr-2">Sanlam Glacier</button>
                            <button type="button" class="btn btn-sm btn-light">SHA</button>
                          </div>
                          <div>
            ...
            <div class="row">
              ...
              <div class="col-lg-8 d-flex grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex flex-wrap justify-content-between">
                      <h4 class="card-title mb-3">Campaign budgets</h4>
                    </div>
                      ...
                      <table class="table">
                        <tbody>
                          <tr>
                            ...
                            <td>
                              Running total
                              <div class="font-weight-bold  mt-1">34,686 ZAR </div>
                            </td>
                            <td>
                              Month total
                              <div class="font-weight-bold  mt-1">17,560 ZAR </div>
                            </td>
                            <td>
                              Overrun
                              <div class="font-weight-bold text-success  mt-1">-8% </div>
                            </td>
                            <td>
                              Timeline
                            ...
                            <td>
                              <i class="typcn typcn-eye-outline mr-1"></i>
                            </td>
                          </tr>
                          <tr>
                            <td>
