...
export default function Home({ data }: { data: dataProps[] }) {
  ...
  const MapWithNoSSR2 = dynamic(() => import("../src/components/MapHotspot"), {
    ssr: false,
  });
  ...
  const _doughnutData = {
    labels: ['Sandton: Bike', 'Sandton: Taxi', 'HydePark: Bike', 'HydePark: Taxi', 'Rosebank: Bike', 'Rosebank: Taxi'],
    datasets: [
      {
        label: '% Allocation',
        data: [12, 19, 3, 5, 2, 3],
          ...
          <div className="content-wrapper">
            ...
            <div className="card">
                  <div className="card-body">
                    <div className="d-flex flex-wrap justify-content-between">
                      <h4 className="card-title mb-3">Drivers & Riders</h4>
                        ...
                        <div className="row">
                          <div className="col-sm-12">
                            <div className="d-flex justify-content-between mt-4 mb-4">
                              <div className="font-weight-medium">Driver</div>
                              <div className="font-weight-medium">Select</div>
                            </div>
                            <div className="d-flex justify-content-between mt-4 mb-4">
                              <div className="text-secondary font-weight-medium">JWW897GP </div>
                              <div className="small"><input className="mt-2" type="checkbox"/></div>
                            </div>
                            <div className="d-flex justify-content-between mb-4">
                              <div className="text-secondary font-weight-medium">FED332GP</div>
                              <div className="small"><input className="mt-2" type="checkbox"/></div>
                              
                            </div>
                            <div className="d-flex justify-content-between mb-4">
                              <div className="text-secondary font-weight-medium">JYE332GP</div>
                              <div className="small"><input className="mt-2" type="checkbox"/>  </div>
                             
                            </div>
                            <div className="d-flex justify-content-between mb-4">
                              <div className="text-primary font-weight-medium">TRD308GP </div>
                              <div className="small"><input className="mt-2" type="checkbox" checked/></div>
                            </div>
                            <div className="d-flex justify-content-between mb-4">
                              <div className="text-secondary font-weight-medium">TXI631GP</div>
                              <div className="small"><input className="mt-2" type="checkbox"/></div>
                            </div>
                            <div className="d-flex justify-content-between mb-4">
                              <div className="text-secondary font-weight-medium">MXC656GP</div>
                              <div className="small"><input className="mt-2" type="checkbox"/></div>
                            </div>
                            <div className="d-flex justify-content-between mb-4">
                                <div className="text-secondary font-weight-medium">BBT099GP</div>
                                <div className="small"><input className="mt-2" type="checkbox"/></div>
                              </div>
                              <div className="d-flex justify-content-between mb-4">
                                <div className="text-secondary font-weight-medium">BPO899GP</div>
                                <div className="small"><input className="mt-2" type="checkbox"/></div>
                              </div>
                              <div className="d-flex justify-content-between mb-4">
                                <div className="text-secondary font-weight-medium">LIO887GP</div>
                                <div className="small"><input className="mt-2" type="checkbox"/></div>
                              </div>
              ...
              <div className="col-xl-9 d-flex grid-margin stretch-card">
                <div className="card">
                  <div className="card-body">
                    <div className="d-flex flex-wrap justify-content-between">
                      <h4 className="card-title mb-3">Tracking</h4>
                      <div className="col-md-6 ">
                      <button type="button" className="float-right btn btn-sm btn-primary ml-2">Today</button>
                      <button type="button" className="float-right btn btn-sm btn-light mr-2">This week</button>
                      <button type="button" className="float-right btn btn-sm btn-light mr-2">Last 30 days</button>
                      </div>
            ...
            <div className="row">
              ...
              <div className="card">
                  <div className="card-body">
                    <div className="d-flex flex-wrap justify-content-between">
                      <h4 className="card-title mb-3">Media by buffer zone</h4>
                        ...
                        <div className="row">
                          <div className="col-sm-12">
                            <div className="d-flex justify-content-between mt-4 mb-4">
                              ...
                              <div className="font-weight-medium">Media</div>
                            </div>
                            <div className="d-flex justify-content-between mt-4 mb-4">
                  ...
                  <div className="card-body">
                    <div className="d-flex flex-wrap justify-content-between">
                      <h4 className="card-title mb-3">Impressions by buffer zone</h4>
                      ...
                      <div className="col-12">
                        <div className="row">
                          <div className="col-sm-12">
                            ...
                            <div className="d-flex justify-content-between mt-4 mb-4">
                              <div className="text-secondary font-weight-medium">Sandton, Sandton </div>
                              <div className="small">78K</div>
                            </div>
                            <div className="d-flex justify-content-between mb-4">
                              <div className="text-secondary font-weight-medium">Rosebank, Sandton</div>
                              <div className="small">22K</div>
                            </div>
                            <div className="d-flex justify-content-between mb-4">
                              <div className="text-secondary font-weight-medium">Hydepark, Sandton</div>
                              <div className="small">17K</div>
                            </div>
