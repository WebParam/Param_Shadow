          ...
          <div class="content-wrapper">
                        ...
                        <div class="col-12">
                            <div class="d-md-flex mb-4">
                              ...
                              <div class="mr-md-5 mb-4">
                                ...
                                <h1 style={{fontSize:"2em"}} class="text-primary mb-1 font-weight-bold">13,221</h1>
                              </div>
                              <div class="mr-md-5 mb-4">
                                <h5 class="mb-1">Drivers</h5>
                                <h1 style={{fontSize:"2em"}} class="text-primary mb-1 font-weight-bold">13,221</h1>
                      ...
                      <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="d-md-flex mt-4">
                              ...
                              <div class="mr-md-5 mb-4">
                                ...
                                <h1 style={{fontSize:"3em"}} class="text-secondary mb-1 font-weight-bold">13,221</h1>
                              </div>
                        ...
                        <div class="col-12">
                            <div class="d-md-flex mb-4">
                              ...
                              <div class="mr-md-5 mb-4">
                                <h5 class="mb-1">Drivers</h5>
                                <h1 style={{fontSize:"2em"}} class="text-secondary mb-1 font-weight-bold">13,221</h1>
                              </div>
                              <div class="mr-md-5 mb-4">
                                <h5 class="mb-1">Drivers</h5>
                                <h1 style={{fontSize:"2em"}} class="text-secondary mb-1 font-weight-bold">13,221</h1>
                      ...
                      <div class="col-12">
                        <div class="row">
                          ...
                          <div class="d-md-flex mb-2">
                            ...
                            <div class="mr-md-6 mb-2 mr-4" style={{width:"45%"}}>
                              <h5 class="mb-1">Active boards</h5>
                              <Doughnut data={_doughnutData}/>
                            </div>
                            <div class="mr-md-5 mb-4 ml-4">
                              <h5 class="mb-1">Total boards</h5>
                              <h1 class="text-warning mb-1 font-weight-bold">74</h1>
                              <h5 class="mb-1">Total Drivers</h5>
                              <h1 class="text-warning mb-1 font-weight-bold">52</h1>
                              <h5 class="mb-1">Total Riders</h5>
                              <h1 class="text-warning mb-1 font-weight-bold">22</h1>
                            </div>
                        ...
                        <div class="row mt-4">
                          <div class="col-12">
                            <div class="d-md-flex mb-2">
                              ...
                              <div class="mr-md-5 mb-4" style={{width:"35%"}}>
                                <h5 class="mb-1">Active boards</h5>
                                <Doughnut data={_doughnutData}/>
                              </div>
                              <div class="mr-md-5 mb-4" style={{width:"35%"}}>
            ...
            <div class="row  mt-3">
              ...
              <div class="card">
                  <div class="card-body">
                    <div class="d-flex flex-wrap justify-content-between">
                      <h4 class="card-title mb-3">Active campaigns</h4>
                    </div>
                      ...
                      <table class="table">
                        <tbody>
                          <tr>
                            ...
                            <td>
                              Effeciency
                              <div class="font-weight-bold text-success  mt-1">72% </div>
                            </td>
                            <td>
                              Riders
                              <div class="font-weight-bold text-success  mt-1">72% </div>
                            ...
                            <td>
                              Assets
                              <div class="font-weight-bold  mt-1"><a href=""></a>view assets</div>
                            </td>
                            <td>
            ...
            <div class="row  mt-3">
              ...
              <div class="card">
                  <div class="card-body">
                    <div class="d-flex flex-wrap justify-content-between">
                      <h4 class="card-title mb-3">Closed campaigns</h4>
                    </div>
                    <div class="table-responsive">
                      <table class="table">
                        <tbody>
